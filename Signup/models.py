...
class UserManager(BaseUserManager):
    def create_user(self, email, first_name,last_name, user_type, password=None, username=None, **extra_fields):
        """
    ...
    def create_superuser(self, email, password,**extra_fields):
        ...
        user = self.create_user(email, password=password,first_name=None,last_name=None,user_type=None,**extra_fields)
        user.is_active = True
        user.save(using=self._db)
